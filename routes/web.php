...
Route::group(['middleware' => ['auth', 'verified']], function () {
    ...
    Route::post('/sptp-storeNegeri', 'MobileController@storeNegeri')->name('mobile.storeNegeri');
    ...
    Route::delete('/sptp-deleteExtra/{id}', 'MobileController@deleteExtra')->name('mobile.deleteExtra');
